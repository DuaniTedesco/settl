"""
Execute com: python seed_runner.py
Funciona no Windows (PowerShell) e Linux/Mac.
"""
import os
import sys
import django
...
u1, _ = User.objects.get_or_create(
    ...
    defaults=dict(
        username='admin@rachar.com',
        first_name='Admin',
        last_name='Teste',
        pix_key='admin@rachar.com',
        is_staff=True,
        is_superuser=True,
    )
)
...
g, created = Group.objects.get_or_create(
    ...
    defaults=dict(
        type='republica',
        description='Nossa rep do segundo ano',
        created_by=u1,
    )
)
if created:
...
print()
print("Usuários:")
print("  admin@rachar.com  /  admin123  (admin)")
print("  joao@teste.com    /  teste123")
print("  maria@teste.com   /  teste123")
